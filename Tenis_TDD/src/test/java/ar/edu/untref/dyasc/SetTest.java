...
public class SetTest {
	...
	@Test
	public void cuandoJugadorUnoHaceUnSetSeActualizaElPuntaje() {
		...
		assertThat(setsJugadorUno).isEqualTo(1);
		assertThat(puntosJugadorDos).isEqualTo(0);
	}

	@Test
	public void cuandoJugadorUnoHaceDosSetSeActualizaElPuntaje() {
		Partido partido = new Partido();
		...
		assertThat(puntosJugadorUno).isEqualTo(0);
		assertThat(gamesJugadorUno).isEqualTo(0);
		assertThat(setsJugadorUno).isEqualTo(2);
		assertThat(puntosJugadorDos).isEqualTo(0);
	}

	@Test
	public void cuandoJugadorDosHaceUnSetSeActualizaElPuntaje() {
		Partido partido = new Partido();
		...
		assertThat(setsJugadorDos).isEqualTo(1);
		assertThat(puntosJugadorUno).isEqualTo(0);
	}

	@Test
	public void cuandoJugadorDosHaceDosSetSeActualizaElPuntaje() {
		Partido partido = new Partido();
		...
		assertThat(puntosJugadorDos).isEqualTo(0);
		assertThat(gamesJugadorDos).isEqualTo(0);
		assertThat(setsJugadorDos).isEqualTo(2);
		assertThat(puntosJugadorUno).isEqualTo(0);
	}
